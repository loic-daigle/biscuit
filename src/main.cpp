...
// OMIT_FONTS drops the entire Noto Sans family (16 glyph tables) to save
// flash; every Noto Serif size above stays, since it's the default font.
#ifndef OMIT_FONTS
...
void setup() {
  ...
  LOG_DBG("MAIN", "Starting Panda version " CROSSPOINT_VERSION);
