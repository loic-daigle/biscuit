...
Panda supports saving multiple OPDS servers and switching between them when browsing catalogs.
...
Panda can sync reading progress with KOReader-compatible sync servers.
